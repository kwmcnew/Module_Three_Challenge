...
with open(output_path, 'w') as file:
    ...
    file.write("Total: ${net_total}\n")
    file.write("Average Change: ${average_change:.2f}\n")
    file.write("Greatest Increase in Profits: {greatest_increase_date} (${greatest_increase})\n")
    file.write("Greatest Decrease in Profits: {greatest_decrease_date} (${greatest_decrease})\n")
